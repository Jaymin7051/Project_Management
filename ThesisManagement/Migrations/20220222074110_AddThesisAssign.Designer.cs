...
namespace ThesisManagement.Migrations
{
    ...
    [Migration("20220222074110_AddThesisAssign")]
    partial class AddThesisAssign
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThesisManagement.Models.ThesisAssign", b =>
                {
                    ...
                    b.ToTable("ThesisAssigns");
                });

            modelBuilder.Entity("ThesisManagement.Models.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ThesisManagement.Models.Faculty", b =>
                {
                    b.HasOne("ThesisManagement.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ThesisManagement.Models.ThesisAssign", b =>
                {
                    b.HasOne("ThesisManagement.Models.Faculty", "Faculty")
                        .WithMany()
